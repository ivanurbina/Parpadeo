 ...
 // Updated:         10/2021 BY  Alfredo Chacón A.

#ifndef GPIO_MSP432_H_
#define GPIO_MSP432_H_
#include "system.h"
#include "Drivers/bool2.h"      // Se incluye aunque no se utiliza, pero puede sustituir a "bool"
...
// Bits. ESTO TAMBIEN SE ENCUENTRA EN "msp432p401r.h" PERO EN HEXADECIMAL
#define B0    0
#define B1    1
#define B2    2
#define B3    3
